...
interface StepFoodAgricultureLocationContactProps {
  locale: Locale;
...
export const StepFoodAgricultureLocationContact: React.FC<StepFoodAgricultureLocationContactProps> = ({
  locale,
  data,
  onChange,
}) => {
      ...
      <div className="space-y-6 pt-4 border-t border-slate-200">
        ...
        <div>
          ...
          <div className="mt-2 flex items-center">
            ...
            />
            <label htmlFor="fag-hidePhone" className={`ml-2 text-sm text-slate-600 ${rtl ? 'mr-2' : 'ml-2'}`}>
