...
export interface FoodAgricultureMediaData {
  photos: UploadedPhoto[];
  videos?: string[]; // Optional video URLs
}

interface StepFoodAgricultureMediaProps {
  locale: Locale;
  data: FoodAgricultureMediaData;
  onChange: (data: Partial<FoodAgricultureMediaData>) => void;
}

export const StepFoodAgricultureMedia: React.FC<StepFoodAgricultureMediaProps> = ({ locale, data, onChange }) => {
    ...
    <div className="space-y-8">
      ...
      <div className="space-y-4">
        ...
        <ImageUploader
          ...
          maxPhotos={20}
          folder="listings/food-agriculture"
