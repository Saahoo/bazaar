...
import { InputField, SelectField } from './SpareFieldControls';

interface StepSpareGeneralDetailsProps {
  locale: Locale;
  data: {
    price: number | '';
  ...
  onChange: (updates: Partial<StepSpareGeneralDetailsProps['data']>) => void;
}
