...
export interface BusinessIndustryLocationContactData {
  // Location fields
  street: string;
  city: string;
  postalCode: string;
...
interface StepBusinessIndustryLocationContactProps {
  locale: Locale;
  data: BusinessIndustryLocationContactData;
  onChange: (data: Partial<BusinessIndustryLocationContactData>) => void;
}
...
export const StepBusinessIndustryLocationContact: React.FC<StepBusinessIndustryLocationContactProps> = ({
  locale,
  data,
  onChange,
}) => {
      ...
      <div className="space-y-6 pt-4 border-t border-slate-200">
        ...
        <div>
          ...
          <div className="mt-2 flex items-center">
            ...
            />
            <label htmlFor="bi-hidePhone" className={`ml-2 text-sm text-slate-600 ${rtl ? 'mr-2' : 'ml-2'}`}>
