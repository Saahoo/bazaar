...
interface StepSportsContactProps {
  locale: Locale;
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="relative">
          <input type="tel" placeholder={t('whatsappPlaceholder')} className={inputClass(!!errors.whatsapp)} dir="ltr" {...register('whatsapp')} />
      ...
      <div className={`flex items-start gap-3 ${rtl ? 'flex-row-reverse' : ''}`}>
        ...
        />
        <label htmlFor="sports-terms" className={`text-sm text-slate-600 cursor-pointer ${rtl ? 'text-right' : 'text-left'}`}>
