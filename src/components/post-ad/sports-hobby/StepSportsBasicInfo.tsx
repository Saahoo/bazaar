...
import { SPORTS_HOBBY_SUBCATEGORIES, SportsHobbySubcategory, SPORTS_HOBBY_SUBCATEGORY_LABEL_KEYS } from '@/lib/constants/sports-hobby-wizard';

const SUBCATEGORY_LABEL_KEYS: Record<SportsHobbySubcategory, string> = SPORTS_HOBBY_SUBCATEGORY_LABEL_KEYS;

interface StepSportsBasicInfoProps {
  locale: Locale;
  data: {
    title: string;
    details: string;
  ...
  onChange: (data: { title?: string; details?: string; subcategory?: SportsHobbySubcategory | '' }) => void;
}
...
export const StepSportsBasicInfo: React.FC<StepSportsBasicInfoProps> = ({ locale, data, onChange }) => {
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <select
          ...
          onChange={(e) => onChange({ subcategory: (e.target.value as SportsHobbySubcategory) || '' })}
        ...
        >
          ...
          {SPORTS_HOBBY_SUBCATEGORIES.map((option) => (
