...
export const StepAnimalsLocationContact: React.FC<StepAnimalsLocationContactProps> = ({
  locale,
  data,
  onChange,
}) => {
      ...
      <div className="space-y-6 pt-4 border-t border-slate-200">
        ...
        <div>
          ...
          <div className="mt-2 flex items-center">
            ...
            />
            <label htmlFor="hidePhone" className={`ml-2 text-sm text-slate-600 ${rtl ? 'mr-2' : 'ml-2'}`}>
