...
export interface ShoppingGroceriesLocationContactData {
  // Location fields
  street: string;
  city: string;
  postalCode: string;
...
interface StepShoppingGroceriesLocationContactProps {
  locale: Locale;
  data: ShoppingGroceriesLocationContactData;
  onChange: (data: Partial<ShoppingGroceriesLocationContactData>) => void;
}
...
export const StepShoppingGroceriesLocationContact: React.FC<StepShoppingGroceriesLocationContactProps> = ({
  locale,
  data,
  onChange,
}) => {
        ...
        <div>
          ...
          <div className="mt-2 flex items-center">
            <input
              ...
              className="w-4 h-4 text-primary-600 rounded border-slate-300 focus:ring-primary-200"
            />
            <label htmlFor="sg-hidePhone" className={`ml-2 text-sm text-slate-600 ${rtl ? 'mr-2' : 'ml-2'}`}>
