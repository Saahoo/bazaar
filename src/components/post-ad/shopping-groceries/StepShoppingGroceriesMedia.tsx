...
export interface ShoppingGroceriesMediaData {
  photos: UploadedPhoto[];
  videos?: string[]; // Optional video URLs
}

interface StepShoppingGroceriesMediaProps {
  locale: Locale;
  data: ShoppingGroceriesMediaData;
  onChange: (data: Partial<ShoppingGroceriesMediaData>) => void;
}

export const StepShoppingGroceriesMedia: React.FC<StepShoppingGroceriesMediaProps> = ({ locale, data, onChange }) => {
    ...
    <div className="space-y-8">
      ...
      <div className="space-y-4">
        ...
        <ImageUploader
          ...
          maxPhotos={20}
          folder="listings/shopping-groceries"
