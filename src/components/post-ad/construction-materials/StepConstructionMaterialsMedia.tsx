...
export interface ConstructionMaterialsMediaData {
  photos: UploadedPhoto[];
  videos?: string[]; // Optional video URLs
}

interface StepConstructionMaterialsMediaProps {
  locale: Locale;
  data: ConstructionMaterialsMediaData;
  onChange: (data: Partial<ConstructionMaterialsMediaData>) => void;
}

export const StepConstructionMaterialsMedia: React.FC<StepConstructionMaterialsMediaProps> = ({ locale, data, onChange }) => {
    ...
    <div className="space-y-8">
      ...
      <div className="space-y-4">
        ...
        <ImageUploader
          ...
          maxPhotos={20}
          folder="listings/construction-materials"
