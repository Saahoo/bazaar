// src/components/homepage/TrendingItems.tsx
'use client';
        ...
        >
          {displayListings.map((listing, index) => (
            ...
            >
              ...
              >
                <div className="overflow-hidden rounded-[1.25rem] border border-slate-200/80 bg-white shadow-sm transition-all duration-300 will-change-transform hover:-translate-y-1 hover:border-orange-200 hover:shadow-xl hover:shadow-orange-100/50">
